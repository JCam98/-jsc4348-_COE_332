...
# Specify the version of Python Interpreter:                                                                                                                                                                                                
...
''' Use the JSON library to dump the data structure into a json file whose file\
 name (animals.json) will be read in by the user": '''
